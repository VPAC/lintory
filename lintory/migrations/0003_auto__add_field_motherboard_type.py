...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'motherboard.type'
        db.add_column('lintory_motherboard', 'type', self.gf('lintory.mfields.char_field')(default='i386', max_length=20), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'motherboard.type'
        db.delete_column('lintory_motherboard', 'type')
