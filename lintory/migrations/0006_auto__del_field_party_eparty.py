...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'party.eparty'
        db.delete_column('lintory_party', 'eparty')
    
    
    def backwards(self, orm):
        
        # Adding field 'party.eparty'
        db.add_column('lintory_party', 'eparty', self.gf('lintory.mfields.char_field')(blank=True, max_length=104, null=True, db_index=True), keep_default=False)
